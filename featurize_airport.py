...
# If it is a medium-airport or large-airport, extract the coordinates
    ...
    with open('ufo_awesome_test.json') as f:
        ...
        for line in f:
            try:
                ...
                # Find the closest airport in [airport_name, shortest_distance]
                ufo_coordinates = (ufo_location.longitude,
                                   ufo_location.latitude)
                ...
                for curr in airports_list:
                    ...
                    curr_distance = great_circle(
                        ufo_coordinates, airport_coordinates).miles
