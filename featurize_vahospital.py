...
def get_hospitals(hospital_features_list):
    with open('VAFacilityLocation.json') as f:
        ...
        for entry in data["VAFacilityData"]:
            ...
            hospital_features_list.append((hospital_name, hospital_region, hospital_coordinates))
        ...
        with open('ufo_awesome_with_airport_shooting.json') as g:
            ...
            for line_a, line_b in zip(f,g):
                try:
                    ...
                    #[closest hospital name, closest hospital distance, closest hospital region]
                    closest_hospital = []
                    ...
                    for curr in hospital_features_list:
                        ...
                        curr_distance = great_circle(ufo_coordinates, hospital_coordinates).miles
                        ...
                        if curr_distance < shortest_distance:
                            ...
                            if len(closest_hospital) == 0:
                                ...
                                closest_hospital.append(closest_hospital_region)
